...
describe "#translate" do
  ...
  it "translates capitalized words into capitalized pig latin" do
    s = translate("This is a Test")
    s.should == "Isthay isay aay Esttay"
  end
  # * retain the punctuation from the original phrase
  it "retains the punctuation from the original phrase" do
    s = translate("Hello there. This is a sentence!")
    s.should == "Ellohay erethay. Isthay isay aay entencesay!"
  end
